const Slide1 = () => {
  return (
    <div 
      className="w-full h-screen flex flex-col justify-around items-end text-right px-6 md:px-8 text-white bg-cover bg-center bg-no-repeat "
      style={{
        backgroundImage: 'url(/sl1.png)'
      }}
    >
        <h1 className="font-josefin-sans uppercase text-[100px] mb-8 leading-tight mr-[-20px] ">
          Causa
        </h1>
